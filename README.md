...
## 🤖 MCP SQLite Database Manager
An intelligent database assistant that bridges the gap between natural language and SQL. Built using Google’s Model Context Protocol (MCP) and OpenAI's GPT-4o-mini, this agent can explore, query, and modify a SQLite database autonomously.
